          ...
          <div className="bg-slate-900 p-10 md:w-1/3 text-white flex flex-col justify-between">
            <div>
              ...
              <p className="text-slate-400 text-sm mb-8">
                Ready to transform your content strategy? Reach out today.
              </p>
          ...
          <div className="p-10 md:w-2/3">
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center">
                ...
                <button onClick={() => setSubmitted(false)} className="mt-6 text-purple-600 underline">
                  Send another
                </button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    className="w-full px-4 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-purple-500 bg-white"
